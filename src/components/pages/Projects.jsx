      ...
      <div className="projects">
        ...
        <div className="box">
          ...
          <figure className='box-infor'>
            ...
            <nav>
              <h2 className='infor-title'>Matematica</h2>
        ...
        <div className="box">
          ...
          <figure className='box-infor'>
            ...
            <nav>
              ...
              <p className='infor-text'>Site galeria estiloso</p>
            </nav>
            <a className='btn-to-project' target={'_blank'} href='https://gallery-5kk475906-gust17x.vercel.app/'>Ver projeto</a>
        ...
        <div className="box">
          ...
          <figure className='box-infor'>
            <nav>
              ...
              <p className='infor-text'><span className='span-infor'>Uma prova online para desenvolvedores react</span></p>
            </nav>
